...
<div class="container">
		...
		<table class="table">
			...
			<tbody>
				...
				<c:forEach var="meal" items="${meals}">
					<tr>
						<td><a href="/meals/${meal.getId()}"><c:out value="${meal.getName()}"/></a></td>
						<td style="display:flex"><a href="/meals/${meal.getId()}/edit" class="btn btn-primary">edit</a> 
							<form action="/meals/${meal.getId()}" method="post">
	...
	<div class="row">
		<p><a href="/meals/new">+ add a meal</a></p>
	</div>
</div>
